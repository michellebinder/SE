...
public class Client{
    ...
    public static void main(String[] args) {
        ...
        microwaveOven.packingInstruction();
        tv.packingInstruction();
        wineGlass.packingInstruction();
        coffeeTable.packingInstruction();
        bed.packingInstruction();
        cupboard.packingInstruction();
    }
}
